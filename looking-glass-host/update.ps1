...
function global:au_GetLatest {
    ...
    $bleeding_edge_url = 'https://looking-glass.io' + ($downloads_page.links | Where-Object href -match "/artifact/B\d-\w{3}-\w{8}/host" | Select-Object -First 1 -ExpandProperty href)
