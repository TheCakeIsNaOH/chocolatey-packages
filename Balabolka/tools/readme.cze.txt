...
Licence: Freeware
Operaèní systém: Microsoft Windows XP/Vista/7/8/10
...
*** Instalace ***
    ...
    Tichá instalace a odinstalace je možná použitím pøepínaèe pøíkazového øádku "-silent".



*** Moduly pro pøevod textu na øeè ***

    Pro ètení textových souborù Balabolka používá moduly pøevodu textu na øeè (TTS).
    Máte-li nìkterý modul TTS instalován, seznam dostupných hlasù bude viditelný v hlavním oknì Balabolky.

    Program podporuje obì verze rozhraní SAPI (SAPI 4 i SAPI 5).
    SAPI 4 je však starší a je pomalu na ústupu. Proto doporuèuji používat spíše SAPI 5.

    Máte-li zájem o kvalitnìjší hlasové syntézy, více informací získáte v nápovìdì Balabolky.



*** Microsoft Speech Platform ***

    Microsoft Speech Platform sestává z knihoven samotného rozhraní a balíèkù jednotlivých jazykù, obsahujících moduly pro rozpoznávání øeèi a její syntézu. Balíèky pro rozpoznávání øeèi a její syntézu jsou distribuovány samostatnì.
...
*** Podpora ***
    ...
    Chcete-li napomoct dalšímu vývoji Balabolky, zakupte si mùj program Cross+A:
