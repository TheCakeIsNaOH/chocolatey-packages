...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url64         = 'https://github.com/nextcloud-releases/desktop/releases/download/v33.0.5/Nextcloud-33.0.5-x64.msi'
  checksum64    = 'a0b7fb3b31ac38d8fe04a4280b83c3a05664d0af38b875d792a79b06f5b4a2f3'
