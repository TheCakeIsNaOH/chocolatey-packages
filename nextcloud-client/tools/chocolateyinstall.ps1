...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url64         = 'https://github.com/nextcloud-releases/desktop/releases/download/v33.0.1/Nextcloud-33.0.1-x64.msi'
  checksum64    = 'fe4904d75d4f1d5ce7dddb7862963f013ee97bda1ed451f0c4c1b267a4317341'
