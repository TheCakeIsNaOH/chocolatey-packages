...
$packageArgs = @{
  ...
  fileType      = 'MSI'
  url64         = 'https://github.com/nextcloud-releases/desktop/releases/download/v4.0.8/Nextcloud-4.0.8-x64.msi'
  checksum64    = 'bfca6d0c8be5a9ef083ebd6c85b92749484e2dfc580c70e8286cd0d41b5ed53f'
