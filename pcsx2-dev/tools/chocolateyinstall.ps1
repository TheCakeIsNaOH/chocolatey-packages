...
$file32sse4 = Join-Path $toolsDir 'pcsx2-v1.7.2136-windows-32bit-SSE4.7z'
$file64sse4 = Join-Path $toolsDir 'pcsx2-v1.7.2136-windows-64bit-SSE4.7z'
$file32avx2 = Join-Path $toolsDir 'pcsx2-v1.7.2136-windows-32bit-AVX2.7z'
$file64avx2 = Join-Path $toolsDir 'pcsx2-v1.7.2136-windows-64bit-AVX2.7z'
