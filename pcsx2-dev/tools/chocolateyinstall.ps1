...
$SSE4_Qt = Join-Path $toolsDir 'pcsx2-v1.7.3573-windows-64bit-SSE4-Qt.7z'
$SSE4_wxWidgets = Join-Path $toolsDir 'pcsx2-v1.7.3573-windows-64bit-SSE4-wxWidgets.7z'
$AVX2_Qt = Join-Path $toolsDir 'pcsx2-v1.7.3573-windows-64bit-AVX2-Qt.7z'
$AVX2_wxWidgets = Join-Path $toolsDir 'pcsx2-v1.7.3573-windows-64bit-AVX2-wxWidgets.7z'
