...
$packageArgs = @{
  ...
  checksum               = 'add3fbfe8d443df64eecbaeebbe83b2c9db655ea2e6293dce78ee94d3deee623'
  checksum64             = 'c8a17263910648e41fd1cd968fd2f27115a30df97763bb1b9101d4219249e6b5'
  checksumType           = 'sha256'
